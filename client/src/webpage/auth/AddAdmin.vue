            ...
            <div class="d-flex align-items-center">
              ...
              <div class="w-100">
                ...
                <b-form-text id="email-block" class="text-left"
                  >Your email address, there will be no authentication
                  whatsoever</b-form-text
                >
              </div>
            </div>
            ...
            <div class="d-flex align-items-center">
              ...
              <div class="w-100">
                <b-input
                  type="text"
                  id="username"
                  aria-describedby="username-block"
                  v-model="username"
                ></b-input>
                <b-form-text id="username-block" class="text-left"
                  >Your username will be required for login</b-form-text
                >
              </div>
            </div>
            ...
            <div class="d-flex align-items-center">
              ...
              <div class="w-100">
                ...
                <b-form-text id="password-block" class="text-left"
                  >Please dont type 123456 for your password</b-form-text
                >
              </div>
            </div>
